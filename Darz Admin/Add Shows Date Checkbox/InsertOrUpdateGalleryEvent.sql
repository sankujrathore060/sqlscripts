ALTER PROCEDURE [dbo].[InsertOrUpdateGalleryEvent]
	...
	@IsCommingSoonDisplayInWebsite BIT = 0
AS
BEGIN
    ...
    BEGIN
        INSERT INTO [dbo].[GalleryEvent] ([GalleryId], [Title], [TitleFa], [Curator], [CuratorFa], [Description],
										  ...
										  PremiumShowWallNumberLimit, Body, BodyFa, IsBodyDisplayInWebsite, IsCommingSoonDisplayInWebsite)
        VALUES
    ...
    WHEN CHARINDEX('-1', @ToDateFa) > 0 THEN
		 ...
		 @BookId, @Mobile_PosterImageUri, @Mobile_PosterImageHeight, @Mobile_PosterImageWidth,
		 @IsPremiumShow,@Collaboration,@CollaborationFa,@CollaborationIds,@GallerySpaceId,@GallerySpaceAddress, @PremiumShowWallNumberLimit, @Body, @BodyFa, @IsBodyDisplayInWebsite, @IsCommingSoonDisplayInWebsite);
    ...
    BEGIN
        ...
        SET
			...
			IsCommingSoonDisplayInWebsite = @IsCommingSoonDisplayInWebsite
        WHERE
            Id = @Id;
