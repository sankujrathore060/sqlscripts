-- DealerCollection_GetAllGrid @DealerId = 38
ALTER PROCEDURE [dbo].[DealerCollection_GetAllGrid] 
	@DealerId INT = 0,	
    @ArtistId INT = 0,
    @PageNo INT = 0,
    @PageSize INT = 10,
...
BEGIN
   ...
   SET @Sql = N';With CTE AS (SELECT 
			...
			WHERE   
				...
				(ISNULL(' + Cast(@DealerId AS NVARCHAR(20)) + N',0) = 0 OR (afmp.DealerId = ' + Cast(@DealerId AS NVARCHAR(20)) + N'))';
